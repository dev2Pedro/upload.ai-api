...
async function main() {
  // Limpa todos os prompts existentes
  await prisma.prompt.deleteMany();
  console.log("Todos os prompts antigos foram removidos.");

  // Cria o prompt para títulos de YouTube
...
'''`.trim(),
  ...
  console.log("Prompt 'Título YouTube' criado com sucesso!");

  // Cria o prompt para descrição de YouTube
  await prisma.prompt.create({
    data: {
...
'''`.trim(),
  ...
  console.log("Prompt 'Descrição YouTube' criado com sucesso!");
}
